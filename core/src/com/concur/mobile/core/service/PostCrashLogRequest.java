...
public class PostCrashLogRequest extends PostServiceRequest {
    ...
    private static final String CLS_TAG = PostCrashLogRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/log/PostClientCrashLog";
    ...
    protected String buildRequestBody() {
        ...
        sb.append("<CrashLog>");
        addElement(sb, "ProductVersion", "Android, " + version);
        addElement(sb, "Text", ((stack != null) ? FormatUtil.escapeForXML(stack) : "No Stack"));
        addElement(sb, "UserName", ((user != null) ? FormatUtil.escapeForXML(user) : ""));
        sb.append("</CrashLog>");
