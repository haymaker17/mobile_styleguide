 ...
 * 
 * @deprecated - use {@link com.concur.platform.ui.common.view.InlineTextFormFieldView} instead.
 * @author AndrewK
 */
public class InlineTextFormFieldView extends FormFieldView {
     ...
     */
    public InlineTextFormFieldView(ExpenseReportFormField frmFld, IFormFieldViewListener listener) {
    ...
    public ValidityCheck isValueValid() {
        ...
        if (frmFld.getAccessType() != ExpenseReportFormField.AccessType.HD
                && frmFld.getAccessType() == ExpenseReportFormField.AccessType.RW && frmFld.isVerifyValue()) {
                ...
                if (frmFld.getDataType() != null) {
                    ...
                    case MONEY:
                        ...
                        if (TRANSACTION_AMOUNT_FIELD_ID.equalsIgnoreCase(frmFld.getId())) {
                            Double finalAmount = FormatUtil.parseAmount(curValue, ConcurCore.getContext()
                    ...
                    case NUMERIC: {
                        ...
                        Double amtDbl = FormatUtil.parseAmount(curValue, ConcurCore.getContext().getResources()
    ...
    public void commit() {
        if (frmFld.getAccessType() == ExpenseReportFormField.AccessType.RW) {
        	String curValue = getCurrentValue();
            if (curValue != null && curValue.length() > 0) {        	
            	frmFld.setValue(formatValueForWire(curValue.trim()));
            }
        }
    }
