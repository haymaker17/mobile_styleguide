...
/**
 * An extension of <code>PostServiceRequest</code> for the purposes of submitting a report for approval.
 * 
 * @author AndrewK
 */
public class SubmitReportRequest extends PostServiceRequest {

    private static final String CLS_TAG = SubmitReportRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/Expense/SubmitReportV2";

    public String reportKey;

    /**
     * Optional employee key of an approver.
     */
    public String approverEmpKey;
    ...
    protected HttpEntity getPostEntity(ConcurService concurService) throws ServiceRequestException {
        ...
        try {
            entity = new StringEntity("", Const.HTTP_BODY_CHARACTER_ENCODING);
    ...
    protected String getServiceEndpointURI() {
        ...
        if (approverEmpKey != null) {
            strBldr.append('/');
            strBldr.append(approverEmpKey);
        }
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ...
        SubmitReportReply reply = new SubmitReportReply();
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            String xmlResponse = readStream(is, encoding);
            try {
                reply = SubmitReportReply.parseXMLReply(xmlResponse);
            } catch (Exception e) {
