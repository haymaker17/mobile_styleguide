...
import com.concur.mobile.core.expense.report.service.SaveReportEntryReply.SaveReportEntrySAXHandler;
import com.concur.mobile.core.service.ActionStatusServiceReply;
import com.concur.mobile.core.util.Const;

/**
 * An extension of <code>ActionStatusServiceReply</code> for parsing the response to a <code>SaveReportEntryReceiptRequest</code>.
 * 
 * @author AndrewK
 */
public class SaveReportEntryReceiptReply extends ActionStatusServiceReply {

    private static final String CLS_TAG = SaveReportEntryReceiptReply.class.getSimpleName();

    public ExpenseReportEntryDetail expRepEntDet;

    public static SaveReportEntryReceiptReply parseReply(String responseXml) {

        SaveReportEntryReceiptReply srvReply = null;
        SAXParserFactory factory = SAXParserFactory.newInstance();
        try {
            SAXParser parser = factory.newSAXParser();
            ActionStatusSAXHandler handler = new SaveReportEntryReceiptSAXHandler();
            parser.parse(new ByteArrayInputStream(responseXml.getBytes()), handler);
            srvReply = (SaveReportEntryReceiptReply) handler.getReply();
    ...
    protected static class SaveReportEntryReceiptSAXHandler extends ActionStatusSAXHandler {

        private static final String CLS_TAG = SaveReportEntryReceiptReply.CLS_TAG
                ...
                if (reportEntryDetailHandler != null) {
                    ...
                    if (localName.equalsIgnoreCase(REPORT_ENTRY_DETAIL) || localName.equalsIgnoreCase(REPORT_ENTRY)) {
                        ...
                        if (entries != null && entries.size() == 1) {
                            ((SaveReportEntryReceiptReply) reply).expRepEntDet = (ExpenseReportEntryDetail) entries
                                    .get(0);
                        } else {
                    ...
                    if (!elementHandled && this.getClass().equals(SaveReportEntryReceiptSAXHandler.class)) {
