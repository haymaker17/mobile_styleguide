...
/**
 * An extension of <code>ServiceRequest</code> for processing report rejection responses.
 * 
 * @author AndrewK
 */
public class RejectReportRequest extends PostServiceRequest {

    private static final String CLS_TAG = RejectReportRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/Expense/RejectExpenseReport";
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            String xmlStr = readStream(is, encoding);
            try {
                reply = ReportApproveRejectServiceReply.parseReply(xmlStr);
            } catch (Exception e) {
