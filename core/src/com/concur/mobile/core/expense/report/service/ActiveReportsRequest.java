...
public class ActiveReportsRequest extends GetServiceRequest {

    public static final String CLS_TAG = ActiveReportsRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/Expense/GetActiveReports";
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ActiveReportsReply reply = new ActiveReportsReply();
