...
/**
 * An extension of <code>GetServiceRequest</code> to obtain default attendee information.
 */
public class DefaultAttendeeRequest extends GetServiceRequest {

    private static final String CLS_TAG = DefaultAttendeeRequest.class.getSimpleName();

    /**
     * Contains the service end-point.
     */
    public static final String SERVICE_END_POINT = "/mobile/Expense/GetDefaultAttendee";
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = DefaultAttendeeReply.parseReply(xmlReply);
            } catch (Exception e) {
