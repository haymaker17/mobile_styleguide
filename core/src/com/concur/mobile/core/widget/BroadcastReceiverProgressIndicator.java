 ...
 * 
 * @deprecated - use {@link com.concur.platform.ui.common.view.BroadcastReceiverProgressIndicator} instead.
 * @author AndrewK
 */
public class BroadcastReceiverProgressIndicator extends ProgressBar {

    private static final String LOG_TAG = "CONCUR";
    ...
    protected void onAttachedToWindow() {
        Log.d(LOG_TAG, CLS_TAG + ".onAttachedToWindow: ");
    ...
    protected void onDetachedFromWindow() {
        Log.d(LOG_TAG, CLS_TAG + ".onDetachedFromWindow: ");
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        Log.d(LOG_TAG, CLS_TAG + ".onWindowVisibilityChanged: visibility -> " + visibleStr);
