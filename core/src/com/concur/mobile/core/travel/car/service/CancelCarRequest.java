...
/**
 * An extension of <code>PostServiceRequest</code> for the purposes of cancelling a car booking.
 */
public class CancelCarRequest extends PostServiceRequest {

    private static final String CLS_TAG = CancelCarRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/Car/CancelCar";

    public static String buildRequestBody(String bookingSource, String reason, String recordLocator, String segmentKey,
            String tripId) {
        StringBuilder strBldr = new StringBuilder();
        strBldr.append("<CarCancel>");
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = CancelCarReply.parseReply(responseXml);
            } catch (Exception e) {
