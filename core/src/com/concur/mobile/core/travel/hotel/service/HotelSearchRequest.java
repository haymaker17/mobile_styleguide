...
/**
 * An extension of <code>PostServiceRequest</code> for performing a hotel search.
 * 
 * @author AndrewK
 */
public class HotelSearchRequest extends PostServiceRequest {

    private static final String CLS_TAG = HotelSearchRequest.class.getSimpleName();
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = HotelSearchReply.parseXmlReply(getReader(is, encoding));
            } catch (Exception e) {
