...
public class HotelRoom {
    ...
    public static class RoomSAXHandler extends DefaultHandler {
        ...
        private static final String GDS_NAME = "gdsName";
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            if (localName.equalsIgnoreCase(CRN_CODE)) {
                ...
                room.travelPoints = Parse.safeParseInteger(chars.toString().trim());
                elementHandled = true;
            } else if (localName.equalsIgnoreCase("CanRedeemTravelPointsAgainstViolations")) {
                room.canRedeemTravelPointsAgainstViolations = Parse.safeParseBoolean(chars.toString().trim());
                elementHandled = true;
            } else if (localName.equalsIgnoreCase(GDS_NAME)) {
                room.gdsName = chars.toString().trim();
                elementHandled = true;
