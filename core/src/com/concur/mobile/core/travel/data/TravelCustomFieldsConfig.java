...
import com.concur.mobile.core.travel.data.TravelCustomField.TravelCustomFieldSAXHandler;
...
public class TravelCustomFieldsConfig {
    ...
    public static TravelCustomFieldsConfig parseTravelCustomFieldsConfig(String xmlReply) throws IOException {
