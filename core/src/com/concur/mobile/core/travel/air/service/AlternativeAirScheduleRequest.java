...
public class AlternativeAirScheduleRequest extends PostServiceRequest {
    ...
    private static final String CLS_TAG = AlternativeAirScheduleRequest.class.getSimpleName();
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        AlternativeAirScheduleReply reply = new AlternativeAirScheduleReply();
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = AlternativeAirScheduleReply.parseXMLReply(responseXml);
            } catch (Exception e) {
    ...
    protected String buildRequestBody() {
        ...
        body.append("<AirScheduleRequest>");
        addElement(body, "ArrivalIATACode", arriveIATA);
        addElement(body, "CarrierCode", carrierCode);
        addElement(body, "DepartureIATACode", departIATA);
        String date = Format.safeFormatCalendar(FormatUtil.LONG_YEAR_MONTH_DAY, flightDate);
        addElement(body, "FlightDate", date);
        body.append("</AirScheduleRequest>");
