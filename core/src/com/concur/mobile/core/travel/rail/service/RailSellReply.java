...
public class RailSellReply extends ServiceReply {
    ...
    public static RailSellReply parseXMLReply(String responseXml) {

        RailSellReply reply = null;
    ...
    protected static class RailSellReplySAXHandler extends DefaultHandler {
        ...
        private RailSellReply reply;

        protected RailSellReply getReply() {
            return reply;
        }
