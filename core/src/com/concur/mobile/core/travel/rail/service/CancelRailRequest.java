...
/**
 * An extension of <code>PostServiceRequest</code> for the purposes of cancelling a rail booking.
 */
public class CancelRailRequest extends PostServiceRequest {

    private static final String CLS_TAG = CancelRailRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/Rail/AmtrakCancel";
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        CancelRailReply reply = new CancelRailReply();
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = CancelRailReply.parseReply(responseXml);
            } catch (Exception e) {
