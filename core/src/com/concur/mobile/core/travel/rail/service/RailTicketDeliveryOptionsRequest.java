...
public class RailTicketDeliveryOptionsRequest extends PostServiceRequest {

    private static final String CLS_TAG = RailTicketDeliveryOptionsRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/mobile/Rail/AmtrakGetDeliveryOptions";
    ...
    protected String buildRequestBody() {
        ...
        body.append("<RailGetDeliveryOptions>");
    ...
    protected ServiceReply processResponse(HttpURLConnection response, ConcurService concurService) throws IOException {
        RailTicketDeliveryOptionsReply reply = new RailTicketDeliveryOptionsReply();
        ...
        if (response.getResponseCode() == HttpStatus.SC_OK) {
            ...
            try {
                reply = RailTicketDeliveryOptionsReply.parseXMLReply(responseXml);
            } catch (Exception e) {
