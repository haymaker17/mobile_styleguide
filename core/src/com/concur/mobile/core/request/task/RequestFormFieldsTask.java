...
public class RequestFormFieldsTask extends AbstractRequestWSCallTask {
    ...
    public RequestFormFieldsTask(Context context, int id, BaseAsyncResultReceiver receiver, String formID,
            boolean isHeader) {
    ...
    protected String getServiceEndPoint() throws ServiceRequestException {
        ...
        return ConnectHelper.getServiceEndpointURI(ConnectHelper.ConnectVersion.VERSION_3_0, Module.FORM_FIELDS,
                isHeader ? Action.FORM_FIELDS_HEADER : Action.FORM_FIELDS_SEGMENT, params, true);
    }
