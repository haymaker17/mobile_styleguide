...
/**
 * Created by Michael Becherer on 10-Sep-15.
 */
public class CoreTestRunner extends RobolectricTestRunner {
    protected String appCompatResDirFormat = "../core/build/intermediates/exploded-aar/com.android.support/appcompat-v7/%s/res";
    protected String[] appCompatVersionsToCheck = {
            "21.0.3",
            "22.2.1"
    };

    public CoreTestRunner(final Class<?> testClass) throws InitializationError {
        super(testClass);
    }
