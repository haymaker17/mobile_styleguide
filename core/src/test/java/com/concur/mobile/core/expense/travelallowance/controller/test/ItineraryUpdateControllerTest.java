...
public class ItineraryUpdateControllerTest extends TestCase {

    private ItineraryUpdateController controller;

    @Before
    public void setup() {
        this.controller = new ItineraryUpdateController(new Activity());
    }
