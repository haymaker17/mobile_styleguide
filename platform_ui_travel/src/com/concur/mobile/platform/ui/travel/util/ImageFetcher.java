...
public class ImageFetcher extends ImageResizer {
    ...
    private void init(Context context) {
        ...
        mHttpCacheDir = TravelImageCache.getDiskCacheDir(context, HTTP_CACHE_DIR);
    }
    ...
    private void initHttpDiskCache() {
        ...
        synchronized (mHttpDiskCacheLock) {
            if (TravelImageCache.getUsableSpace(mHttpCacheDir) > HTTP_CACHE_SIZE) {
                try {
    ...
    private Bitmap processBitmap(String data) {
        ...
        final String key = TravelImageCache.hashKeyForDisk(data);
