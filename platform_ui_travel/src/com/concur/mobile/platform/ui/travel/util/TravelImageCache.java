 ...
 * {@link TravelImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} to get an instance of this
...
public class TravelImageCache {
     ...
     * {@link TravelImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} to fetch an ImageCache
     * instance.
     *
     * @param cacheParams The cache parameters to use to initialize the cache
     */
    private TravelImageCache(ImageCacheParams cacheParams) {
        init(cacheParams);
    }

    /**
     * Return an {@link TravelImageCache} instance. A {@link RetainFragment} is used to retain the
     ...
     */
    public static TravelImageCache getInstance(FragmentManager fragmentManager, ImageCacheParams cacheParams) {

        // Search for, or create an instance of the non-UI RetainFragment
        final RetainFragment mRetainFragment = findOrCreateRetainFragment(fragmentManager);

        // See if we already have an ImageCache stored in RetainFragment
        TravelImageCache imageCache = (TravelImageCache) mRetainFragment.getObject();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new TravelImageCache(cacheParams);
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            bitmap = ImageResizer
                                    .decodeSampledBitmapFromDescriptor(fd, Integer.MAX_VALUE, Integer.MAX_VALUE, this);
                        }
                    }
                } catch (final IOException e) {
    ...
    public static class ImageCacheParams {
         ...
         * {@link TravelImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} or
         * {@link ImageWorker#addImageCache(android.app.FragmentManager, ImageCacheParams)}.
         *
