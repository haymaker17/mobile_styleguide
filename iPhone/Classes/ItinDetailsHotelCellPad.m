...
NSString * const ITIN_DETAILS_CELLX_REUSABLE_IDENTIFIER = @"ItinDetailsHotelCellPad";

@implementation ItinDetailsHotelCellPad

@synthesize		lblLine1, lblLine2, lblLine3, lblLine4, lblLine5;
@synthesize		scroller;
@synthesize		imageArray;
@synthesize		pageControl, parentVC, iv, btn, btnAddress, vendor, vendorCode, addr;
...
{
	return ITIN_DETAILS_CELLX_REUSABLE_IDENTIFIER;
}
...
-(IBAction) showAddress:(id)sender
{
	...
	[dvc goSomeplace:lblLine3.text VendorName:self.vendor VendorCode:self.vendorCode];
}
@end
