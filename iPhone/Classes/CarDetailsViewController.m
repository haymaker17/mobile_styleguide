...
//		else 
    ...
    else if ([sectionName isEqualToString:kSectionViolation])
	{
		...
		{
            BOOL customLabelSpecified = [[UserConfig getSingleton].customTravelText[@"CarRulesViolationText"] length] > 0;
            NSString *justification  = [self getViolationJustification];
			
            NSString *label = customLabelSpecified ? [UserConfig getSingleton].customTravelText[@"CarRulesViolationText"] : [Localizer getLocalizedText:@"Violation Justification"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if ([sectionName isEqualToString:kSectionViolation])
	{
		...
		{
            BOOL customLabelSpecified = [[UserConfig getSingleton].customTravelText[@"CarRulesViolationText"] length] > 0;
            NSString *customTitle = customLabelSpecified ? [UserConfig getSingleton].customTravelText[@"CarRulesViolationText"] : [Localizer getLocalizedText:@"Violation Justification"];
			NSString *placeholder = customLabelSpecified ? [UserConfig getSingleton].customTravelText[@"CarRulesViolationText"] : [Localizer getLocalizedText:@"Please enter a justification for booking this car."];
