...
@interface FlightScheduleCell : UITableViewCell
{
    ...
    UIImageView *ivLogo, *ivPref, *ivOvernight, *ivRoundOvernight, *ivRule;
    
    UILabel     *lblDepartIata, *lblDepartTime, *lblArriveIata, *lblArriveTime, *lblDurationStops;
    UILabel     *lblRoundDepartIata, *lblRoundDepartTime, *lblRoundArriveIata, *lblRoundArriveTime, *lblRoundDurationStops, *lblRefundable;
    
    UILabel *lblSeatsText, *lblSeats;
}
...
@property (strong, nonatomic) IBOutlet UILabel     *lblSeatsText;
@property (strong, nonatomic) IBOutlet UILabel     *lblSeats;
@end
