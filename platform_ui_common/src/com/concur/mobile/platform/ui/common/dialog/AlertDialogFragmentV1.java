...
/**
 * A standard extension of {@link DialogFragment} to display alert dialogs with up to 3 buttons. This class is a copy of
 * AlertDialogFragment but has no dependency on support.v4 library
 */
public class AlertDialogFragmentV1 extends DialogFragment {
    ...
    protected AlertDialogFragmentV1.OnClickListener mCancelListener;
