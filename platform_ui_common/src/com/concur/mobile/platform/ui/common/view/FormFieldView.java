...
public abstract class FormFieldView {
    ...
    public static interface IFormFieldViewListener {
        ...
        // Additional API when porting from core to platform.ui.common
        /**
         * Returns the transaction currency for the given field. Currency code is needed to format the amount field.
         * 
         * Original code: listener.getExpenseReportEntry() != null) ? listener.getExpenseReportEntry().transactionCrnCode :
        ...
        /**
         * Returns the user locale from context. Needed for format amount, etc.
         * 
         * <pre>
         * <code>
         * Original code:ConcurCore.getContext().getResources().getConfiguration().locale
         * </code>
         * </pre>
         */
        ...
        /**
         * Return key of the document being edited, e.g. rptKey
         * 
         * @return Return key of the document being edited, e.g. rptKey
         */
        public String getDocumentKey();

        /**
         * Whether should show list codes in list field, e.g. Preferences.shouldShowListCodes()
         * 
         * @return Whether to should show list codes in list field
         */
     ...
     */
    protected FormFieldView(IFormField frmFld, IFormFieldViewListener listener) {
        this.frmFld = frmFld;
    ...
    public void setTextViewText(View container, int textViewId, CharSequence text) {
        if (text != null) {
            if (container != null) {
                ...
                Log.e(Const.LOG_TAG, CLS_TAG + ".setTextViewText: container is null!");
            }
        }
    }
        ...
        if (value != null) {
            if (frmFld.getDataType() != null) {
                ...
                case MONEY: {
                    ...
                    if (amtDbl != null) {
                        String crnCode = listener.getCurrencyCodeForAmountFieldById(this.frmFld.getId());
                        retVal = FormatUtil.formatAmount(amtDbl, listener.getCurrentLocaleInContext(), crnCode, false);
                    }
                    break;
                }
                case NUMERIC: {
        ...
        if (frmFld != null) {
            if (frmFld.getMaxLength() != -1) {
                ...
                InputFilter.LengthFilter filter = new FormFieldLengthFilter(frmFld.getMaxLength(), frmFld.getDataType()
                        .equals(IFormField.DataType.NUMERIC));
    ...
    public CharSequence buildLabel(CharSequence label) {
        if (label != null) {
            if (frmFld.isRequired() && frmFld.getAccessType() != IFormField.AccessType.RO) {
