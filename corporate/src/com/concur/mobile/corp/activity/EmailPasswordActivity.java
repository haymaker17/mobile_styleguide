...
import com.concur.mobile.platform.ui.common.login.EmailPasswordFragment;
...
public class EmailPasswordActivity extends BaseActivity implements IProgressBarListener, EmailPasswordFragment.EmailPasswordCallBacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(EmailPasswordActivity.this, TestDriveRegistration.class);
        ...
        emailText = getIntent().getStringExtra(EmailPasswordFragment.ARGS_EMAIL_TEXT_VALUE);
        ...
        if (emailLookupFragment == null) {
            emailLookupFragment = new EmailPasswordFragment();
            ...
            bundle.putString(EmailPasswordFragment.ARGS_EMAIL_TEXT_VALUE, emailText);
            emailLookupFragment.setArguments(bundle);

            ((EmailPasswordFragment) emailLookupFragment).setProgressBarListener(this);
