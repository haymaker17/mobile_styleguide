...
public class FirstRunExpItTour extends BaseActivity {
        ...
        public boolean onFling(MotionEvent event1, MotionEvent event2, float velocityX, float velocityY) {
            ...
            if (velocityX < -threshold) {
                if (currentChild < flipper.getChildCount() - 1) {
                    flipper.setInAnimation(FirstRunExpItTour.this, R.anim.slide_in_right);
                    flipper.setOutAnimation(FirstRunExpItTour.this, R.anim.slide_out_left);
                    showContinue();
                    flipper.showNext();
                ...
                if (currentChild > 0) {
                    flipper.setInAnimation(FirstRunExpItTour.this, R.anim.slide_in_left);
                    flipper.setOutAnimation(FirstRunExpItTour.this, R.anim.slide_out_right);
                    showNext();
