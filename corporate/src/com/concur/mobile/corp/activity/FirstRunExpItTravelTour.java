...
public class FirstRunExpItTravelTour extends BaseActivity {
    ...
    private void setPageMaker(){
        ...
        for(int i=0;i<pageMarkers.getChildCount();i++){
            pageMarkers.getChildAt(i).setVisibility(View.VISIBLE);
        }
    }
    //Show continue button
    private void showContinue(int currentChild,boolean buttonHit) {
    ...
    //Show next button
    private void showNext(final int currentChild) {
        launch = (Button) findViewById(R.id.exp_it_travel_continue);
        if(currentChild==1){
            launch.setText(getString(R.string.next));
        }
        ...
        public boolean onFling(MotionEvent event1, MotionEvent event2, float velocityX, float velocityY) {
            ...
            if (velocityX < -threshold) {
                if (currentChild < flipper.getChildCount() - 1) {
                    ...
                    flipper.setInAnimation(FirstRunExpItTravelTour.this, R.anim.slide_in_right);
                    flipper.setOutAnimation(FirstRunExpItTravelTour.this, R.anim.slide_out_left);
                ...
                if (currentChild > 0) {
                    flipper.setInAnimation(FirstRunExpItTravelTour.this, R.anim.slide_in_left);
                    flipper.setOutAnimation(FirstRunExpItTravelTour.this, R.anim.slide_out_right);
