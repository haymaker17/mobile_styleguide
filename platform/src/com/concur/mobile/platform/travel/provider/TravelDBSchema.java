...
public class TravelDBSchema {
    ...
    protected static final String SCHEMA_CREATE_TRIP_SUMMARY_TABLE = "CREATE TABLE IF NOT EXISTS "
            + Travel.TripSummaryColumns.TABLE_NAME + " (" + Travel.TripSummaryColumns._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.TripSummaryColumns.APPROVAL_STATUS + " TEXT, "
            + Travel.TripSummaryColumns.APPROVER_ID + " TEXT, " + Travel.TripSummaryColumns.APPROVER_NAME + " TEXT, "
            + Travel.TripSummaryColumns.AUTHORIZATION_NUMBER + " TEXT, " + Travel.TripSummaryColumns.BOOKED_VIA
            + " TEXT, " + Travel.TripSummaryColumns.BOOKING_SOURCE + " TEXT, "
            + Travel.TripSummaryColumns.CAN_BE_EXPENSED + " INTEGER, " + Travel.TripSummaryColumns.CLIQ_BOOK_STATE
            + " INTEGER, " + Travel.TripSummaryColumns.END_DATE_LOCAL + " TEXT, "
            + Travel.TripSummaryColumns.END_DATE_UTC + " TEXT, " + Travel.TripSummaryColumns.HAS_OTHERS + " INTEGER, "
            ...
            + " INTEGER, " + Travel.TripSummaryColumns.IS_PUBLIC + " INTEGER, " + Travel.TripSummaryColumns.ITIN_ID
            + " INTEGER, " + Travel.TripSummaryColumns.ITIN_LOCATOR + " TEXT, "
            + Travel.TripSummaryColumns.ITIN_SOURCE_LIST + " TEXT, " + Travel.TripSummaryColumns.RECORD_LOCATOR
            + " TEXT, " + Travel.TripSummaryColumns.SEGMENT_TYPES + " TEXT, "
            + Travel.TripSummaryColumns.START_DATE_LOCAL + " TEXT, " + Travel.TripSummaryColumns.START_DATE_UTC
    ...
    protected static final String SCHEMA_CREATE_TRIP_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + Travel.TripColumns.CLIENT_LOCATOR + " TEXT, " + Travel.TripColumns.CLIQBOOK_TRIP_ID + " INTEGER, "
            + Travel.TripColumns.DESCRIPTION + " TEXT, " + Travel.TripColumns.END_DATE_LOCAL + " TEXT, "
            + Travel.TripColumns.END_DATE_UTC + " TEXT, " + Travel.TripColumns.ITIN_LOCATOR + " TEXT, "
            + Travel.TripColumns.RECORD_LOCATOR + " TEXT, " + Travel.TripColumns.START_DATE_LOCAL + " TEXT, "
            + Travel.TripColumns.START_DATE_UTC + " TEXT, " + Travel.TripColumns.STATE + " INTEGER, "
            + Travel.TripColumns.TRIP_NAME + " TEXT, " + Travel.TripColumns.USER_ID + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_SORTABLE_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.SortableSegmentColumns.ENHANCEMENT_DAY_ID
            + " INTEGER REFERENCES " + Travel.EnhancementDayColumns.TABLE_NAME + " ON DELETE CASCADE, "
            + Travel.SortableSegmentColumns.BOOKING_SOURCE + " TEXT, " + Travel.SortableSegmentColumns.RECORD_LOCATOR
    ...
    protected static final String SCHEMA_CREATE_ENHANCEMENT_OFFER_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.EnhancementOfferColumns.TRIP_ID + " INTEGER REFERENCES "
    ...
    protected static final String SCHEMA_CREATE_OFFER_CONTENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.OfferContentColumns.ENHANCEMENT_OFFER_ID
            + " INTEGER REFERENCES " + Travel.EnhancementOfferColumns.TABLE_NAME + " ON DELETE CASCADE, "
    ...
    protected static final String SCHEMA_CREATE_VALIDITY_LOCATION_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.ValidityLocationColumns.ENHANCEMENT_OFFER_ID
            + " INTEGER REFERENCES " + Travel.EnhancementOfferColumns.TABLE_NAME + " ON DELETE CASCADE, "
    ...
    protected static final String SCHEMA_CREATE_VALIDITY_TIME_RANGE_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.ValidityTimeRangeColumns.ENHANCEMENT_OFFER_ID
            + " INTEGER REFERENCES " + Travel.EnhancementOfferColumns.TABLE_NAME + " ON DELETE CASCADE, "
    ...
    protected static final String SCHEMA_CREATE_HOTEL_RULE_VIOLATION_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.HotelRuleViolationColumns.TRIP_ID
    ...
    protected static final String SCHEMA_CREATE_FLIGHT_RULE_VIOLATION_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.FlightRuleViolationColumns.TRIP_ID
            + " INTEGER REFERENCES " + Travel.TripColumns.TABLE_NAME + " ON DELETE CASCADE, "
    ...
    protected static final String SCHEMA_CREATE_RULE_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + Travel.RuleColumns.TEXT + " TEXT, " + Travel.RuleColumns.TRIP_RULE_VIOLATION_ID + " INTEGER, "
    ...
    protected static final String SCHEMA_CREATE_RULE_CAR_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleColumns.TABLE_NAME + "_INDEX_2 ON " + Travel.RuleColumns.TABLE_NAME + "("
            + Travel.RuleColumns.CAR_RULE_VIOLATION_ID + ")";
    protected static final String SCHEMA_CREATE_RULE_HOTEL_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleColumns.TABLE_NAME + "_INDEX_3 ON " + Travel.RuleColumns.TABLE_NAME + "("
            + Travel.RuleColumns.HOTEL_RULE_VIOLATION_ID + ")";
    protected static final String SCHEMA_CREATE_RULE_FLIGHT_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleColumns.TABLE_NAME + "_INDEX_4 ON " + Travel.RuleColumns.TABLE_NAME + "("
    ...
    protected static final String SCHEMA_CREATE_RULE_VIOLATION_REASON_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.RuleViolationReasonColumns.REASON + " TEXT, "
            + Travel.RuleViolationReasonColumns.COMMENTS + " TEXT, " + Travel.RuleColumns.TRIP_RULE_VIOLATION_ID
            + " INTEGER, " + Travel.RuleViolationReasonColumns.CAR_RULE_VIOLATION_ID + " INTEGER, "
    ...
    protected static final String SCHEMA_CREATE_RULE_VIOLATION_REASON_CAR_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "_INDEX_2 ON "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "("
            + Travel.RuleViolationReasonColumns.CAR_RULE_VIOLATION_ID + ")";
    protected static final String SCHEMA_CREATE_RULE_VIOLATION_REASON_HOTEL_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "_INDEX_3 ON "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "("
            + Travel.RuleViolationReasonColumns.HOTEL_RULE_VIOLATION_ID + ")";
    protected static final String SCHEMA_CREATE_RULE_VIOLATION_REASON_FLIGHT_RULE_ID_INDEX = "CREATE INDEX "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "_INDEX_4 ON "
            + Travel.RuleViolationReasonColumns.TABLE_NAME + "("
            + Travel.RuleViolationReasonColumns.FLIGHT_RULE_VIOLATION_ID + ")";
    protected static final String SCHEMA_CREATE_RULE_VIOLATION_REASON_RAIL_RULE_ID_INDEX = "CREATE INDEX "
    ...
    protected static final String SCHEMA_CREATE_TRAVEL_POINT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.TravelPointColumns.TRIP_ID + " INTEGER REFERENCES "
            + Travel.TripColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.TravelPointColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + " ON DELETE CASCADE, "
            + Travel.TravelPointColumns.BENCHMARK + " TEXT, " + Travel.TravelPointColumns.BENCHMARK_CURRENCY
    ...
    protected static final String SCHEMA_CREATE_TRAVEL_POINT_TRIP_ID_INDEX = "CREATE INDEX "
            ...
            + Travel.TravelPointColumns.TRIP_ID + ")";
    ...
    protected static final String SCHEMA_CREATE_BOOKING_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + Travel.TripColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.BookingColumns.AGENCY_PCC + " TEXT, "
            + Travel.BookingColumns.BOOKING_SOURCE + " TEXT, " + Travel.BookingColumns.COMPANY_ACCOUNTING_CODE
            + " TEXT, " + Travel.BookingColumns.DATE_BOOKED_LOCAL + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_PASSENGER_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.PassengerColumns.BOOKING_ID + " INTEGER REFERENCES "
    ...
    protected static final String SCHEMA_CREATE_FREQUENT_TRAVELER_PROGRAM_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.FrequentTravelerProgramColumns.PASSENGER_ID
            + " INTEGER REFERENCES " + Travel.PassengerColumns.TABLE_NAME + " ON DELETE CASCADE, "
    ...
    protected static final String SCHEMA_CREATE_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " TEXT, " + Travel.SegmentColumns.END_DATE_UTC + " TEXT, " + Travel.SegmentColumns.START_DATE_LOCAL
            + " TEXT, " + Travel.SegmentColumns.END_DATE_LOCAL + " TEXT, " + Travel.SegmentColumns.CONFIRMATION_NUMBER
            + " TEXT, " + Travel.SegmentColumns.CREDIT_CARD_ID + " TEXT, "
            + Travel.SegmentColumns.CREDIT_CARD_LAST_FOUR + " TEXT, " + Travel.SegmentColumns.CREDIT_CARD_TYPE
            + " TEXT, " + Travel.SegmentColumns.CREDIT_CARD_TYPE_LOCALIZED + " TEXT, " + Travel.SegmentColumns.CURRENCY
            + " TEXT, " + Travel.SegmentColumns.ERECEIPT_STATUS + " TEXT, " + Travel.SegmentColumns.END_ADDRESS
            + " TEXT, " + Travel.SegmentColumns.END_ADDRESS_2 + " TEXT, " + Travel.SegmentColumns.END_CITY + " TEXT, "
            + Travel.SegmentColumns.END_CITY_CODE + " TEXT, " + Travel.SegmentColumns.END_CITY_CODE_LOCALIZED
            + " TEXT, " + Travel.SegmentColumns.END_COUNTRY + " TEXT, " + Travel.SegmentColumns.END_COUNTRY_CODE
            + " TEXT, " + Travel.SegmentColumns.END_LATITUDE + " REAL, " + Travel.SegmentColumns.END_LONGITUDE
            + " REAL, " + Travel.SegmentColumns.END_POSTAL_CODE + " TEXT, " + Travel.SegmentColumns.END_STATE
            + " TEXT, " + Travel.SegmentColumns.FREQUENT_TRAVELER_ID + " TEXT, "
            + Travel.SegmentColumns.IMAGE_VENDOR_URI + " TEXT, " + Travel.SegmentColumns.NUM_PERSONS + " INTEGER, "
            + Travel.SegmentColumns.OPERATED_BY_VENDOR + " TEXT, " + Travel.SegmentColumns.OPERATED_BY_VENDOR_NAME
            + " TEXT, " + Travel.SegmentColumns.PHONE_NUMBER + " TEXT, " + Travel.SegmentColumns.RATE_CODE + " TEXT, "
            + Travel.SegmentColumns.SEGMENT_KEY + " TEXT, " + Travel.SegmentColumns.SEGMENT_LOCATOR + " TEXT, "
            + Travel.SegmentColumns.SEGMENT_NAME + " TEXT, " + Travel.SegmentColumns.START_ADDRESS + " TEXT, "
            + Travel.SegmentColumns.START_ADDRESS_2 + " TEXT, " + Travel.SegmentColumns.START_CITY + " TEXT, "
            + Travel.SegmentColumns.START_CITY_CODE + " TEXT, " + Travel.SegmentColumns.START_COUNTRY + " TEXT, "
            + Travel.SegmentColumns.START_COUNTRY_CODE + " TEXT, " + Travel.SegmentColumns.START_LATITUDE + " REAL, "
            + Travel.SegmentColumns.START_LONGITUDE + " REAL, " + Travel.SegmentColumns.START_POSTAL_CODE + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_AIR_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.AirSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.AirSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", " + Travel.AirSegmentColumns.AIRCRAFT_CODE
            + " TEXT, " + Travel.AirSegmentColumns.AIRCRAFT_NAME + " TEXT, " + Travel.AirSegmentColumns.CABIN
            + " TEXT, " + Travel.AirSegmentColumns.CHECKED_BAGGAGE + " TEXT, "
            + Travel.AirSegmentColumns.CLASS_OF_SERVICE + " TEXT, "
            + Travel.AirSegmentColumns.CLASS_OF_SERVICE_LOCALIZED + " TEXT, " + Travel.AirSegmentColumns.DURATION
            + " INTEGER, " + Travel.AirSegmentColumns.END_AIRPORT_CITY + " TEXT, "
            + Travel.AirSegmentColumns.END_AIRPORT_COUNTRY + " TEXT, "
            + Travel.AirSegmentColumns.END_AIRPORT_COUNTRY_CODE + " TEXT, " + Travel.AirSegmentColumns.END_AIRPORT_NAME
            + " TEXT, " + Travel.AirSegmentColumns.END_AIRPORT_STATE + " TEXT, " + Travel.AirSegmentColumns.END_GATE
            + " TEXT, " + Travel.AirSegmentColumns.END_TERMINAL + " TEXT, " + Travel.AirSegmentColumns.FARE_BASIS_CODE
            + " TEXT, " + Travel.AirSegmentColumns.FLIGHT_NUMBER + " TEXT, " + Travel.AirSegmentColumns.LEG_ID
            + " INTEGER, " + Travel.AirSegmentColumns.MEALS + " TEXT, " + Travel.AirSegmentColumns.MILES + " INTEGER, "
            + Travel.AirSegmentColumns.NUM_STOPS + " INTEGER, " + Travel.AirSegmentColumns.OPERATED_BY_FLIGHT_NUMBER
            + " TEXT, " + Travel.AirSegmentColumns.SPECIAL_INSTRUCTIONS + " TEXT, "
            + Travel.AirSegmentColumns.START_AIRPORT_CITY + " TEXT, " + Travel.AirSegmentColumns.START_AIRPORT_COUNTRY
            + " TEXT, " + Travel.AirSegmentColumns.START_AIRPORT_COUNTRY_CODE + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_FLIGHT_STATUS_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.FlightStatusColumns.AIR_SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.AirSegmentColumns.TABLE_NAME + " ON DELETE CASCADE, "
            + Travel.FlightStatusColumns.EQUIPMENT_SCHEDULED + " TEXT, " + Travel.FlightStatusColumns.EQUIPMENT_ACTUAL
            + " TEXT, " + Travel.FlightStatusColumns.EQUIPMENT_REGISTRATION + " TEXT, "
            + Travel.FlightStatusColumns.DEPARTURE_TERMINAL_SCHEDULED + " TEXT, "
            + Travel.FlightStatusColumns.DEPARTURE_TERMINAL_ACTUAL + " TEXT, "
            + Travel.FlightStatusColumns.DEPARTURE_GATE + " TEXT, " + Travel.FlightStatusColumns.DEPARTURE_SCHEDULED
            + " TEXT, " + Travel.FlightStatusColumns.DEPARTURE_ESTIMATED + " TEXT, "
            ...
            + Travel.FlightStatusColumns.ARRIVAL_TERMINAL_ACTUAL + " TEXT, " + Travel.FlightStatusColumns.ARRIVAL_GATE
            + " TEXT, " + Travel.FlightStatusColumns.ARRIVAL_SCHEDULED + " TEXT, "
            + Travel.FlightStatusColumns.ARRIVAL_ESTIMATED + " TEXT, " + Travel.FlightStatusColumns.ARRIVAL_ACTUAL
            + " TEXT, " + Travel.FlightStatusColumns.BAGGAGE_CLAIM + " TEXT, "
            + Travel.FlightStatusColumns.DIVERSION_CITY + " TEXT, " + Travel.FlightStatusColumns.DIVERSION_AIRPORT
            + " TEXT, " + Travel.FlightStatusColumns.ARRIVAL_STATUS_REASON + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_HOTEL_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.HotelSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.HotelSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", "
            + Travel.HotelSegmentColumns.CHECK_IN_TIME + " TEXT, " + Travel.HotelSegmentColumns.CHECK_OUT_TIME
            + " TEXT, " + Travel.HotelSegmentColumns.DISCOUNT_CODE + " TEXT, " + Travel.HotelSegmentColumns.NUM_ROOMS
            + " TEXT, " + Travel.HotelSegmentColumns.RATE_CODE + " TEXT, " + Travel.HotelSegmentColumns.ROOM_TYPE
            + " TEXT, " + Travel.HotelSegmentColumns.ROOM_TYPE_LOCALIZED + " TEXT, "
            + Travel.HotelSegmentColumns.DAILY_RATE + " REAL, " + Travel.HotelSegmentColumns.TOTAL_RATE + " REAL, "
            + Travel.HotelSegmentColumns.CANCELLATION_POLICY + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_CAR_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.CarSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.CarSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", " + Travel.CarSegmentColumns.AIR_CONDITION
            + " TEXT, " + Travel.CarSegmentColumns.AIR_CONDITION_LOCALIZED + " TEXT, " + Travel.CarSegmentColumns.BODY
            + " TEXT, " + Travel.CarSegmentColumns.BODY_LOCALIZED + " TEXT, " + Travel.CarSegmentColumns.CLASS_OF_CAR
            + " TEXT, " + Travel.CarSegmentColumns.CLASS_OF_CAR_LOCALIZED + " TEXT, "
            + Travel.CarSegmentColumns.DAILY_RATE + " REAL, " + Travel.CarSegmentColumns.DISCOUNT_CODE + " TEXT, "
            + Travel.CarSegmentColumns.END_AIRPORT_CITY + " TEXT, " + Travel.CarSegmentColumns.END_AIRPORT_COUNTRY
            + " TEXT, " + Travel.CarSegmentColumns.END_AIRPORT_COUNTRY_CODE + " TEXT, "
            + Travel.CarSegmentColumns.END_AIRPORT_NAME + " TEXT, " + Travel.CarSegmentColumns.END_AIRPORT_STATE
            + " TEXT, " + Travel.CarSegmentColumns.END_LOCATION + " TEXT, " + Travel.CarSegmentColumns.IMAGE_CAR_URI
            + " TEXT, " + Travel.CarSegmentColumns.NUM_CARS + " INTEGER, " + Travel.CarSegmentColumns.RATE_TYPE
            + " TEXT, " + Travel.CarSegmentColumns.SPECIAL_EQUIPMENT + " TEXT, "
            + Travel.CarSegmentColumns.START_AIRPORT_CITY + " TEXT, " + Travel.CarSegmentColumns.START_AIRPORT_COUNTRY
            + " TEXT, " + Travel.CarSegmentColumns.START_AIRPORT_COUNTRY_CODE + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_RAIL_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.RailSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.RailSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", " + Travel.RailSegmentColumns.AMENITIES
            + " TEXT, " + Travel.RailSegmentColumns.CABIN + " TEXT, " + Travel.RailSegmentColumns.CLASS_OF_SERVICE
            + " TEXT, " + Travel.RailSegmentColumns.DISCOUNT_CODE + " TEXT, " + Travel.RailSegmentColumns.DURATION
            + " INTEGER, " + Travel.RailSegmentColumns.END_PLATFORM + " TEXT, "
            + Travel.RailSegmentColumns.END_RAIL_STATION + " TEXT, "
            + Travel.RailSegmentColumns.END_RAIL_STATION_LOCALIZED + " TEXT, " + Travel.RailSegmentColumns.LEG_ID
            + " INTEGER, " + Travel.RailSegmentColumns.MEALS + " TEXT, " + Travel.RailSegmentColumns.MILES
            + " INTEGER, " + Travel.RailSegmentColumns.NUM_STOPS + " INTEGER, "
            + Travel.RailSegmentColumns.OPERATED_BY_TRAIN_NUMBER + " TEXT, " + Travel.RailSegmentColumns.PIN
            + " TEXT, " + Travel.RailSegmentColumns.START_PLATFORM + " TEXT, "
    ...
    protected static final String SCHEMA_CREATE_DINING_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.DiningSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
    ...
    protected static final String SCHEMA_CREATE_PARKING_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.ParkingSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.ParkingSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", "
    ...
    protected static final String SCHEMA_CREATE_RIDE_SEGMENT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.RideSegmentColumns.BOOKING_ID + " INTEGER REFERENCES "
            + Travel.BookingColumns.TABLE_NAME + " ON DELETE CASCADE, " + Travel.RideSegmentColumns.SEGMENT_ID
            + " INTEGER REFERENCES " + Travel.SegmentColumns.TABLE_NAME + ", "
            ...
            + Travel.RideSegmentColumns.MILES + " INTEGER, " + Travel.RideSegmentColumns.NUMBER_OF_HOURS + " REAL, "
            + Travel.RideSegmentColumns.PICK_UP_INSTRUCTIONS + " TEXT, " + Travel.RideSegmentColumns.RATE + " REAL, "
    ...
    protected static final String SCHEMA_CREATE_LOCATION_CHOICE_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Travel.LocationChoiceColumns.CITY + " TEXT, "
            + Travel.LocationChoiceColumns.COUNTRY + " TEXT, " + Travel.LocationChoiceColumns.COUNTRY_ABBREVIATION
    ...
    protected static final String SCHEMA_CREATE_HOTEL_SEARCH_RESULT_TABLE = "CREATE TABLE IF NOT EXISTS "
            ...
            + Travel.HotelSearchResultColumns.CREATED_AT_DATETIME + " DEFAULT CURRENT_TIMESTAMP" + ")";
