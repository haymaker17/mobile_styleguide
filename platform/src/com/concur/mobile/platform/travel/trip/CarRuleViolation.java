...
/**
 * An extension of <code>BaseParser</code> for the purpose of parsing car rule violation information.
 */
public class CarRuleViolation extends BaseParser {
    ...
    /**
     * Constructs an instance of <code>CarRuleViolation</code> with a common parser and a start tag.
     * 
     * @param parser
     ...
     */
    public CarRuleViolation(CommonParser parser, String startTag) {
    ...
    public void handleText(String tag, String text) {
        if (!TextUtils.isEmpty(tag)) {
            if (tag.equalsIgnoreCase(TAG_DAILY_RATE)) {
