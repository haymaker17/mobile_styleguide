...
/**
 * Provides an abstract class to support encapsulating database schema upgrade actions.
 * 
 * @author andrewk
 */
public abstract class SchemaUpgradeAction {

    private static final String CLS_TAG = "SchemaUpgradeAction";
    ...
    protected PlatformSQLiteDatabase db;
     ...
     */
    protected SchemaUpgradeAction(PlatformSQLiteDatabase db, int oldVersion, int newVersion) {
        this.db = db;
