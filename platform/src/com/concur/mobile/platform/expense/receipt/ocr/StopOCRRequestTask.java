 ...
 *
 */
public class StopOCRRequestTask extends PlatformAsyncRequestTask {

    /**
     * Class name used for logging.
     */
    public static final String CLS_TAG = StopOCRRequestTask.class.getName();

    /**
     * Key used to bundle the StopOCR result object.
     */
    public static final String STOP_OCR_RESULT_KEY = "STOP_OCR_RESULT";
     ...
     */
    private static final String SERVICE_END_POINT = "/mobile/expense/v1.0/receipts/%s/StopOCR/mobile";

    /**
     * Object holding the result of calling this endpoint.
     */
    protected StopOCR stopOcr;
    ...
    /**
     * Constructs an instance of <code>StopOCRRequestTask</code>.
     * 
     * @param context
     ...
     */
    public StopOCRRequestTask(Context context, int requestId, BaseAsyncResultReceiver receiver, String receiptImageId) {
    ...
    protected int parseStream(HttpURLConnection connection, InputStream is) {
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpStatus.SC_OK) {
                ...
                MWSResponse<StopOCR> mwsResp = gson.fromJson(
                        new InputStreamReader(new BufferedInputStream(is), "UTF-8"), type);
    ...
    protected int onPostParse() {
        ...
        if (stopOcr != null) {
            ...
            if (stopOcr.errors != null && !stopOcr.errors.isEmpty()) {
                result = BaseAsyncRequestTask.RESULT_ERROR;
            }

            resultData.putSerializable(STOP_OCR_RESULT_KEY, stopOcr);
        }
