...
public class CommonTestSuite extends PlatformTestSuite {
    ...
    public void doAutoLogin() throws Exception {
        ...
        AutoLoginRequestTaskTest autoLoginTest = new AutoLoginRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doPinPasswordLoginLight() throws Exception {
        ...
        PPLoginLightRequestTaskTest test = new PPLoginLightRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doEmailLookUp() throws Exception {
        ...
        EmailLookUpRequestTaskTest test = new EmailLookUpRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doRequestPasswordReset() throws Exception {
        ...
        RequestPasswordResetRequestTaskTest test = new RequestPasswordResetRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doResetUserPassword() throws Exception {
        ...
        ResetUserPasswordRequestTaskTest test = new ResetUserPasswordRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doSystemConfig() throws Exception {
        ...
        SystemConfigRequestTaskTest sysConfigTask = new SystemConfigRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doUserConfig() throws Exception {
        ...
        UserConfigRequestTaskTest userConfigTask = new UserConfigRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doStartOcr() throws Exception {
        ...
        StartOCRRequestTaskTest startOcrTest = new StartOCRRequestTaskTest(PlatformTestApplication.useMockServer());
        initTaskMockServer(startOcrTest);

        // First, get the list of Receipts so we can grab one of them to StartOCR on.
        ReceiptListRequestTaskTest receiptListTest = new ReceiptListRequestTaskTest(PlatformTestApplication.useMockServer());
    ...
    public void doStopOcr() throws Exception {
        ...
        StopOCRRequestTaskTest stopOcrTask = new StopOCRRequestTaskTest(PlatformTestApplication.useMockServer());
