...
/**
 * An extension of <code>AsyncRequestTest</code> for the purpose of testing the <code>AutoLoginRequestTask</code> platform
 * request.
 * 
 * @author andrewk
 */
public class AutoLoginRequestTaskTest extends AsyncRequestTest {

    private static final String CLS_TAG = "AutoLoginRequestTaskTest";

    private static final boolean DEBUG = false;

    public AutoLoginRequestTaskTest(boolean useMockServer) {
        super(useMockServer);
    }
    ...
    public void doTest() throws Exception {
        ...
        if (useMockServer()) {
            ...
            setMockResponse(mockServer, HttpStatus.SC_OK, "authentication/AutoLoginResponse.xml");
        }

        // Initiate the auto login request.
