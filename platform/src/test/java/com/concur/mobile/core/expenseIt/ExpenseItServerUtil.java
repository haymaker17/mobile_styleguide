...
*/
package com.concur.mobile.core.expenseIt;
...
public class ExpenseItServerUtil {
    ...
    public enum Server {
        ...
        public static String obfuscate(String key) {
            String flipped = Server.flip(key != null ? key.toCharArray() : new char[0]);
            String decoded = null;
            try {
                decoded = new String(Base64.encode(flipped.getBytes(), Base64.DEFAULT), "UTF-8");
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
            return decoded;
