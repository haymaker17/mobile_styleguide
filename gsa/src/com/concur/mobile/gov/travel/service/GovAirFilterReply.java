...
public class GovAirFilterReply extends AirFilterReply {

    public String rateType;

    public GovAirFilterReply() {
        super();
    }
    ...
    public static GovAirFilterReply parseXMLReply(String responseXml) {

        GovAirFilterReply reply = null;

        SAXParserFactory factory = SAXParserFactory.newInstance();
        try {
            SAXParser parser = factory.newSAXParser();
            GovAirFilterReplySAXHandler handler = new GovAirFilterReplySAXHandler();
    ...
    protected static class GovAirFilterReplySAXHandler extends DefaultHandler {
