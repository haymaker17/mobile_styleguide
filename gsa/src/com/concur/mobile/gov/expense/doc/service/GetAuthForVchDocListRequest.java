...
public class GetAuthForVchDocListRequest extends GetServiceRequest {

    public static final String CLS_TAG = GetAuthForVchDocListRequest.class.getSimpleName();
    public static final String SERVICE_END_POINT = "/Mobile/GovTravelManager/GetAuthForVchTMDocuments";
