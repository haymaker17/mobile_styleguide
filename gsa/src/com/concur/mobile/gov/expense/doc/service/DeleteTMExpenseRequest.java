 ...
 * the DeleteTMExpense MWS endpoint.
 * 
 * @author Chris N. Diaz
 * 
 */
public class DeleteTMExpenseRequest extends PostServiceRequest {

    private static final String CLS_TAG = DeleteTMExpenseRequest.class.getSimpleName();

    public static final String SERVICE_END_POINT = "/Mobile/GovTravelManager/DeleteTMExpense";
    ...
    protected String buildRequestBody() {
        ...
        strBldr.append("<DeleteTMExpenseRequest>");

        ViewUtil.addXmlElement(strBldr, "docName", docName);
        ViewUtil.addXmlElement(strBldr, "docType", docType);
        ViewUtil.addXmlElement(strBldr, "expId", expId);
